...
resource "tls_private_key" "db_key" { # key 생성
  algorithm = "RSA"
  rsa_bits  = 4096
}
...
resource "local_file" "db_pem" {
  filename        = "/home/ec2-user/.ssh/tmp_db.pem"
...
resource "local_file" "ansible_inventory" {
  ...
  # 생성할 파일 경로
  filename = "/home/ec2-user/was/ansible/db.ini"
...
#   SSH pem 키 위치
[db]
${aws_instance.db.private_ip} ansible_user=ec2-user ansible_ssh_private_key_file=/home/ec2-user/.ssh/tmp_db.pem
  ...
  provisioner "local-exec" {
    ...
    command = <<-EOT
      ...
      until ssh \
        ...
        ec2-user@${aws_instance.db.private_ip} \
